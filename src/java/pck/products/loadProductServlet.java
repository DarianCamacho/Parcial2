...
public class loadProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("        <a class=\"btn btn-info\" href=\"getProductsServlet\">Go back</a>");
            out.println("    </div>");
            ...
            out.println("                        <input value='" + resultSet.getInt("Id") + "' name='txtId' type='number' class='form-control' id='txtId' placeholder='100000' required readonly>");
            out.println("                        <label for='txtId'>Id</label>");
            out.println("                    </div>");
            out.println("                    <div class='form-floating mb-3'>");
            out.println("                        <input value='" + resultSet.getString("Name") + "' name='txtName' type='text' class='form-control' id='txtName' placeholder='Product' required>");
            out.println("                        <label for='txtName'>Name</label>");
            out.println("                    </div>        ");
            out.println("                    <div class='form-floating mb-3'>");
            out.println("                        <input value='" + resultSet.getString("Category") + "' name='txtCategory' type='text' class='form-control' id='txtCategory' placeholder='Type' required>");
            out.println("                        <label for='txtCategory'>Category</label>");
            out.println("                    </div> ");
            out.println("                </div>");
            out.println("                <div class='col'>");
            out.println("                    <div class='form-floating mb-3'>");
            out.println("                        <input value='" + resultSet.getInt("Price") + "' name='txtPrice' type='number' class='form-control' id='txtPrice' placeholder='1000000' required>");
            out.println("                        <label for='txtPrice'>Price</label>");
            out.println("                    </div>  ");
            out.println("                    <div class='form-floating mb-3'>");
            out.println("                        <input value='" + resultSet.getString("Date") + "' name='txtDate' type='text' class='form-control' id='txtDate' placeholder='0/0/0' required>");
